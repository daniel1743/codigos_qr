  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={cn(
          "relative w-full cursor-pointer overflow-hidden bg-[#EFEBE5] transition-shadow duration-150 ease-premium",
          selected
            ? "shadow-[0_0_0_2px_#2F6FED]"
            : "hover:shadow-[0_0_0_1px_rgba(47,111,237,0.35)]",
        )}
      >
        ...
        {product.badge && product.imageState === "ready" && (
          <span
            className="absolute left-3 top-3 rounded-full bg-surface/95 px-2.5 py-1 text-[11.5px] font-medium text-ink"
        ...
        {product.imageOrigin === "reference" && product.image && product.imageState === "ready" && (
