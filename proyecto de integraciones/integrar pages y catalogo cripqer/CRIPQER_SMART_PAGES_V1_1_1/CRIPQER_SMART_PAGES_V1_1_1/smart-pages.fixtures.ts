...
const storeContent = base("Verde Casa", "retail", {
  business: {
    name: "Verde Casa",
    businessType: "retail",
    tagline: "Plants, pots and care essentials for small homes",
    about:
      "Verde Casa is a small plant shop in Santiago. We select easy-care indoor plants, pots and tools, and we help you choose what fits your light and your space.",
    category: "Plant shop",
  ...
  catalogs: [
    {
      ...
      items: [
        item("itm_monstera", "product", "Monstera deliciosa", {
          ...
          description: "Large split leaves. Bright indirect light.",
          price: { amount: 15900, currency: "CLP", label: "$15.900" },
          media: [photo("m_mon", "plant1", "Monstera plant")],
          attributes: [{ key: "light", label: "Light", value: "Bright indirect" }],
          featured: true,
          action: action("whatsapp", "Ask on WhatsApp"),
        }),
        item("itm_pothos", "product", "Pothos", {
          categoryId: "cat_plants",
          description: "Trailing plant, tolerates low light.",
          price: { amount: 7900, currency: "CLP", label: "$7.900" },
          media: [photo("m_pot", "plant2", "Pothos plant")],
          attributes: [{ key: "light", label: "Light", value: "Low to medium" }],
        }),
        item("itm_fern", "product", "Boston fern", {
          categoryId: "cat_plants",
          description: "Likes humidity and steady watering.",
          price: { amount: 9900, currency: "CLP", label: "$9.900" },
          media: [photo("m_fern", "fern", "Boston fern in a terracotta pot")],
          attributes: [{ key: "light", label: "Light", value: "Medium" }],
        }),
        item("itm_snake", "product", "Snake plant", {
          categoryId: "cat_plants",
          description: "Very low maintenance, upright leaves.",
          price: { amount: 11900, currency: "CLP", label: "$11.900" },
          media: [photo("m_snake", "snake", "Snake plant in a grey pot")],
          attributes: [{ key: "light", label: "Light", value: "Low to bright" }],
          featured: true,
        }),
        item("itm_cactus", "product", "Small cactus", {
          categoryId: "cat_plants",
          description: "Full sun, water once a month.",
          price: { amount: 4900, currency: "CLP", label: "$4.900" },
          media: [photo("m_cactus", "cactus", "Small cactus in a terracotta pot")],
          attributes: [{ key: "light", label: "Light", value: "Direct sun" }],
        }),
        item("itm_zz", "product", "ZZ plant", {
          categoryId: "cat_plants",
          description: "Thick glossy leaves, forgiving with water.",
          price: { amount: 13900, currency: "CLP", label: "$13.900" },
          media: [photo("m_zz", "zz", "ZZ plant in a white ceramic pot")],
          attributes: [{ key: "light", label: "Light", value: "Low to medium" }],
        }),
        item("itm_ceramic", "product", "Ceramic pot 15 cm", {
          categoryId: "cat_pots",
          description: "Glazed ceramic pot with drainage hole.",
          price: { amount: 6500, currency: "CLP", label: "$6.500" },
          media: [photo("m_cer", "pot1", "Ceramic pot")],
          attributes: [{ key: "size", label: "Size", value: "15 cm" }],
        }),
        item("itm_terracotta", "product", "Terracotta pot 20 cm", {
          categoryId: "cat_pots",
          description: "Classic terracotta, breathable for roots.",
          review: ["price"],
          confidence: 0.7,
          media: [photo("m_ter", "pot2", "Terracotta pot")],
          attributes: [{ key: "size", label: "Size", value: "20 cm" }],
        }),
        item("itm_stand", "product", "Wooden plant stand", {
          categoryId: "cat_home",
          description: "Solid wood tripod stand for medium pots.",
          price: { amount: 18900, currency: "CLP", label: "$18.900" },
          media: [photo("m_stand", "stand", "Wooden plant stand")],
          featured: true,
        }),
        item("itm_can", "product", "Brass watering can", {
          categoryId: "cat_care",
          description: "1 litre, narrow spout for indoor pots.",
          price: { amount: 14900, currency: "CLP", label: "$14.900" },
          media: [photo("m_can", "wateringcan", "Brass watering can")],
        }),
        item("itm_mister", "product", "Glass mister", {
          categoryId: "cat_care",
          description: "Fine spray for ferns and calatheas.",
          price: { amount: 8900, currency: "CLP", label: "$8.900" },
          media: [photo("m_mister", "mister", "Glass plant mister")],
        }),
        item("itm_soil", "product", "Indoor potting mix 5 L", {
          categoryId: "cat_care",
          description: "Light mix with bark and perlite.",
          price: { amount: 5900, currency: "CLP", label: "$5.900" },
          media: [photo("m_soil", "soil", "Bag of indoor potting mix")],
        }),
      ],
    },
  ],
  gallery: [
    photo("g_shop1", "shopcover", "Inside the Verde Casa shop"),
    photo("g_shop2", "shopcollection", "Plants styled in a living room corner"),
  ],
  faq: [
