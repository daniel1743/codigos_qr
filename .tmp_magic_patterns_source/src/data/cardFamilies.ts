...
export const cardFamilies: Record<CardFamily, CardFamilyDef> = {
  catalog: {
    ...
    items: [
    { image: images.bizFacial, title: 'Tratamiento facial luminoso', description: 'Limpieza profunda, exfoliación suave y mascarilla de vitamina C. 60 minutos.', price: '90 €', badge: 'Más reservado', cta: 'Reservar' },
    { image: images.productMug, title: 'Taza de gres artesanal', description: 'Torneada a mano en La Bisbal. Esmalte mate, apta para lavavajillas.', price: '28 €', badge: 'Nuevo', cta: 'Consultar' },
    { image: images.productCandle, title: 'Vela de eucalipto', description: 'Cera de soja y mecha de algodón. Unas 45 horas de combustión.', price: '24 €', cta: 'Ver detalle' }]
  ...
  page: {
    ...
    items: [
    { image: images.bioStill, eyebrow: 'Nuestra filosofía', title: 'Cuidado, sin prisas', description: 'Cada visita empieza con una conversación. Escuchamos antes de proponer nada.', cta: 'Leer más' },
    { image: images.bizClinic, eyebrow: 'Novedad', title: 'Abrimos los sábados', description: 'Desde octubre, sábados de 10:00 a 14:00 con cita previa.', cta: 'Ver horarios' },
    { image: images.bioTable, eyebrow: 'Promoción', title: 'Tarjetas regalo', description: 'Elige importe o tratamiento y la enviamos por email en el momento.', cta: 'Regalar' }]
  ...
  portfolio: {
    ...
    items: [
    { image: images.roomAfter, imageBefore: images.roomBefore, eyebrow: 'Interiorismo', meta: '2025', title: 'Piso Almagro', description: 'Reforma integral de 90 m² con cal, roble y lino.', cta: 'Ver proyecto' },
    { image: images.pfVilla, imageBefore: images.pfHero, eyebrow: 'Arquitectura', meta: '2026', title: 'Casa Albar', description: 'Vivienda unifamiliar frente al mar en Menorca.', cta: 'Ver proyecto' },
    { image: images.pfArch, imageBefore: images.pfStair, eyebrow: 'Fotografía', meta: '2025', title: 'Estudio Cal', description: 'Serie para un estudio de interiorismo en Madrid.', cta: 'Ver proyecto' }]
  ...
  menu: {
    ...
    items: [
    { image: images.dishBurrata, eyebrow: 'Entrantes', title: 'Burrata con tomates de temporada', description: 'Albahaca fresca, aceite arbequina y sal en escamas.', price: '14 €', badge: 'Popular' },
    { image: images.dishFish, eyebrow: 'Principales', title: 'Lubina a la brasa', description: 'Alcaparras, limón asado y verduras de la huerta.', price: '24 €', badge: 'Recomendado' },
    { image: images.dishDessert, eyebrow: 'Postres', title: 'Tarta de queso vasca', description: 'Horneada cada mañana. Con un vermut de la casa.', price: '8 €', badge: 'Nuevo' }]
  ...
  store: {
    ...
    items: [
    { image: images.productTote, title: 'Bolso de lino natural', description: 'Lino lavado y asas de piel curtida vegetal.', price: '49 €', previousPrice: '65 €', badge: '-25%', cta: 'Comprar' },
    { image: images.productMug, title: 'Taza de gres', description: 'Pieza única, torneada a mano.', price: '28 €', previousPrice: '32 €', badge: 'Oferta', cta: 'Comprar' },
    { image: images.productCandle, title: 'Vela de eucalipto', description: 'Cera de soja, 45 horas.', price: '24 €', badge: 'Nuevo', cta: 'Comprar' }]
