...
{ type: 'catalog', label: cardFamilies.catalog.label, description: cardFamilies.catalog.subtitle, icon: LayoutListIcon },
{ type: 'cardPage', label: cardFamilies.page.label, description: cardFamilies.page.subtitle, icon: FileTextIcon },
{ type: 'cardPortfolio', label: cardFamilies.portfolio.label, description: cardFamilies.portfolio.subtitle, icon: BriefcaseIcon },
{ type: 'cardMenu', label: cardFamilies.menu.label, description: cardFamilies.menu.subtitle, icon: UtensilsIcon },
{ type: 'cardStore', label: cardFamilies.store.label, description: cardFamilies.store.subtitle, icon: ShoppingBagIcon }];
...
export const preparedBlockKit: BlockKitItem[] = cardBlockKit.filter((b) => !visibleCardTypes.has(b.type));
