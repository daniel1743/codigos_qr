...
{ kind: 'familyCard', element: 'Tarjeta (familias)', tap: 'Contorno de la tarjeta', actions: ['Diseño', 'Imagen', 'Estilo', 'Duplicar', 'Eliminar', 'Más'] },
{ kind: 'price', element: 'Precio', tap: 'Se escribe en el sitio', actions: ['Editar precio', 'Tamaño', 'Color', 'Ocultar', 'Más'] },
{ kind: 'badge', element: 'Etiqueta', tap: 'Etiqueta seleccionada', actions: ['Texto', 'Estilo', 'Ocultar', 'Quitar'] },
