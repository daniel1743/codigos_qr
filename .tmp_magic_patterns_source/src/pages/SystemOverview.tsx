...
import { CardFamiliesShowcase } from '../components/system/CardFamiliesShowcase';
...
{ id: 'tarjetas', label: 'Familias de tarjetas' },
      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        <div className="mx-auto grid max-w-[1240px] gap-12 px-5 py-12 lg:grid-cols-[200px_1fr] lg:px-10">
          ...
          <main className="min-w-0 space-y-16">
            ...
            <SystemSection
              id="tarjetas"
              title="Familias de tarjetas"
              intro="Cinco familias sobre una misma carcasa de tarjeta. Cada elemento se toca y se edita en el sitio: título, descripción, imagen, precio, etiqueta y botón. La tarjeta completa ofrece Diseño · Imagen · Estilo · Duplicar · Eliminar.">
              
              <CardFamiliesShowcase />
            </SystemSection>
