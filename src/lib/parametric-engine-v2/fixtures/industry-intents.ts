...
export const INDUSTRY_FIXTURES: IndustryFixture[] = [
  make(
    ...
    "professional",
    {
      name: "Fontanería Rivas",
      profession: "Fontanero urgencias 24h",
      bio: "Reparaciones rápidas en toda la ciudad.",
      avatar: AVATAR,
    },
    { type: "whatsapp", value: "+34600111222" },
    {
      ...
      content: {
        services: { available: true, count: 6 },
        service_areas: { available: true, count: 12 },
        trust_facts: { available: true, count: 3 },
      },
  ...
  make(
    ...
    {
      name: "Estudio Nara",
      profession: "Peluquería y color",
      bio: "Color, corte y tratamiento capilar.",
      avatar: AVATAR,
      banner: BANNER,
    },
    { type: "booking", value: "https://calendly.com/nara" },
    {
      ...
      content: {
        services: { available: true, count: 8 },
  ...
  make(
    ...
    "professional",
    {
      name: "Marín & Asociados",
      profession: "Abogados mercantiles",
    ...
    { type: "email", value: "contacto@marinlegal.com" },
    {
      ...
      content: {
        services: { available: true, count: 5 },
        trust_facts: { available: true, count: 4 },
        testimonials: { available: true, count: 6 },
        faq: { available: true, count: 8 },
      },
    },
  ),
  make(
    ...
    {
      name: "Taller Sierra",
      profession: "Carpintería a medida",
      bio: "Muebles de madera maciza.",
      avatar: AVATAR,
      banner: BANNER,
    },
    { type: "instagram", value: "@tallersierra" },
    {
      ...
      content: {
        portfolio: { available: true, count: 20 },
        before_after: { available: true, count: 6 },
        gallery: { available: true, count: 24 },
      },
    },
    true,
  ),
  make(
    ...
    "modern",
    {
      ...
      bio: "Historias reales, luz natural.",
      avatar: AVATAR,
      banner: BANNER,
    },
    { type: "website", value: "https://luciavega.com" },
    {
      ...
      content: {
        portfolio: { available: true, count: 30 },
        gallery: { available: true, count: 40 },
        testimonials: { available: true, count: 10 },
      },
    },
    true,
  ),
  make(
    ...
    {
      name: "Casa Oliva",
      profession: "Hotel boutique",
      bio: "Ocho habitaciones frente al mar.",
      avatar: AVATAR,
      banner: BANNER,
    },
    { type: "booking", value: "https://booking.example.com/casaoliva" },
    {
      ...
      content: {
        gallery: { available: true, count: 30 },
        booking: { available: true },
        locations: { available: true, count: 1 },
        pricing: { available: true, count: 1 },
      },
    },
    true,
  ),
  make(
    ...
    {
      name: "La Brasa",
      profession: "Restaurante de brasa",
      bio: "Cocina de fuego y producto local.",
      avatar: AVATAR,
      banner: BANNER,
    },
    { type: "whatsapp", value: "+34600333444" },
    {
      ...
      content: {
        hours: { available: true },
        locations: { available: true, count: 2 },
        gallery: { available: true, count: 15 },
        pricing: { available: true, count: 1 },
      },
    },
    true,
  ...
  make(
    ...
    {
      name: "Nube Store",
      profession: "Moda sostenible",
      bio: "Prendas hechas en talleres locales.",
      avatar: AVATAR,
    },
    { type: "website", value: "https://nubestore.example.com" },
    {
      ...
      content: {
        products: { available: true, count: 40 },
        pricing: { available: true, count: 1 },
        gallery: { available: true, count: 10 },
      },
    },
    true,
  ),
  ...
  make(
    ...
    "minimal",
    {
      ...
      bio: "Terapia individual, presencial y online.",
      avatar: AVATAR,
    },
    { type: "booking", value: "https://cal.com/anacortes" },
    {
      ...
      content: {
        services: { available: true, count: 4 },
        faq: { available: true, count: 10 },
        booking: { available: true },
        trust_facts: { available: true, count: 3 },
      },
    },
  ...
  make(
    ...
    {
      name: "Idiomas Norte",
      profession: "Academia de inglés",
      bio: "Preparación de exámenes oficiales.",
      avatar: AVATAR,
    },
    { type: "email", value: "info@idiomasnorte.com" },
    {
      ...
      content: {
        services: { available: true, count: 9 },
        pricing: { available: true, count: 1 },
        testimonials: { available: true, count: 12 },
        faq: { available: true, count: 14 },
      },
    },
  ),
  make(
    ...
    "premium",
    {
      ...
      bio: "Compra y venta en la zona centro.",
      avatar: AVATAR,
      banner: BANNER,
    },
    { type: "whatsapp", value: "+34600555666" },
    {
      ...
      content: {
        portfolio: { available: true, count: 18 },
        locations: { available: true, count: 3 },
        trust_facts: { available: true, count: 5 },
        lead_form: { available: true },
      },
    },
    true,
  ),
  make(
    ...
    {
      name: "DJ Kimo",
      profession: "DJ de bodas y eventos",
      bio: "Música sin pausas, ambiente garantizado.",
      avatar: AVATAR,
      banner: BANNER,
    },
    { type: "whatsapp", value: "+34600777888" },
    {
      ...
      content: {
        gallery: { available: true, count: 20 },
        video: { available: true },
        testimonials: { available: true, count: 9 },
        booking: { available: true },
      },
    },
    true,
  ...
  make(
    ...
    "energetic",
    {
      ...
      bio: "Clases en grupos reducidos.",
      avatar: AVATAR,
      banner: BANNER,
    },
    { type: "whatsapp", value: "+34600999000" },
    {
      ...
      content: {
        ...
        hours: { available: true },
        pricing: { available: true, count: 1 },
        testimonials: { available: true, count: 7 },
      },
    },
    true,
  ),
  make(
    ...
    {
      name: "Iker Solá",
      profession: "Consultor de producto digital",
      bio: "Estrategia y discovery para SaaS.",
      avatar: AVATAR,
    },
    { type: "website", value: "https://ikersola.dev" },
    {
      ...
      content: {
        services: { available: true, count: 3 },
        testimonials: { available: true, count: 5 },
        lead_form: { available: true },
        links: { available: true, count: 4 },
      },
    },
  ),
  make(
