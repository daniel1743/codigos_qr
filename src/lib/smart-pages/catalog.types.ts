 ...
 *
 * TRANSIENT SEMANTIC PLANNING TYPES (SMART_PAGES_2): these describe the
 * normalized semantic layer only. They are NOT a database schema, NOT a
 * BioTemplateConfig replacement and NOT a published document format.
 */
