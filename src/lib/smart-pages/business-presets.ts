 ...
 *
 * SMART_PAGES_2 note: presets remain SEMANTIC HINTS. Engine V2 owns all visual
 * authority. The `listings` preset is SEMANTIC ONLY - it must never become a
 * host `public.pages.page_type`.
 */
