 ...
 *
 * SMART_PAGES_2 note: this module outputs SEMANTIC ACTION INTENT only (labels,
 * precedence and safe hrefs). The current Cripqer CTA/destination system and
 * Engine V2 destination policy remain the final host authority. No renderer
 * URL handling or Engine V2 destination logic is changed here.
 */
