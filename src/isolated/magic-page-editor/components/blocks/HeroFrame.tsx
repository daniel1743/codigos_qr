  ...
  switch (variant) {
      ...
      return (
        ...
        >
          ...
          <div className={cx("relative", m && "order-1")}>
            ...
            {avatar && (
              <div className={cx("absolute", m ? "-bottom-8 left-4" : "-bottom-10 -left-10")}>
                {avatar}
              </div>
            )}
          </div>
      ...
      return (
        <div {...data} className="relative overflow-hidden" style={{ minHeight, ...bandShape }}>
          ...
          <div
            ...
            style={{ minHeight, padding: m ? "96px 20px 36px" : "140px 56px 60px", ...onMediaVars }}
          >
    ...
    case "arch": {
      ...
      return (
        <div
          ...
          style={{ paddingTop: m ? 28 : 52 }}
        >
          <div
            className="relative overflow-hidden"
            style={{
              width: w,
              height: Math.round(w * 1.22),
              borderRadius: `${w / 2}px ${w / 2}px ${radius}px ${radius}px`,
            }}
          >
            {img}
            {decor}
          ...
          <div className={cx("flex w-full flex-col items-center", avatar ? "mt-5" : "mt-8")}>
            {children({ align: "center", onMedia: false })}
          </div>
        </div>
      );
    ...
    case "floating":
      return (
        <div
          ...
          style={{ minHeight: H + (m ? 220 : 200), ...bandShape }}
        >
          {img}
          {decor}
          <div
            className="relative w-full"
            style={{ padding: m ? "130px 14px 18px" : "170px 32px 40px" }}
          >
            <div
    ...
    case "banner":
      return (
        <div
          {...data}
          className={cx("mx-auto", m ? "px-3 pb-2 pt-3" : "px-6 pb-4 pt-6")}
          style={{ maxWidth: 1180 }}
        >
          <div
            className="relative overflow-hidden"
            style={{ height: Math.round(H * 0.66), borderRadius: radius }}
          >
            {img}
            {decor}
          </div>
          <div
            className={cx(
              "relative flex",
              m ? "flex-col items-start px-3" : "items-end gap-7 px-8",
            )}
          >
    ...
    case "mosaic": {
      ...
      return (
        <div
          ...
          className={cx(
            "mx-auto grid items-center",
            m ? "grid-cols-1 gap-9 px-5 py-6" : "grid-cols-[1fr_1.1fr] gap-14 px-10 py-14",
          )}
          style={{ maxWidth: 1180 }}
        >
          <div className={cx("flex flex-col items-start text-left", m && "order-2")}>
          ...
          <div
            className={cx("grid grid-cols-[1.4fr_1fr] grid-rows-2", m && "order-1")}
            style={{ gap: m ? 8 : 12, height: Math.round((m ? 300 : 460) * SCALE[heightKey]) }}
          >
        ...
        <div {...data} className={cx("mx-auto", m ? "p-3" : "p-8")} style={{ maxWidth: 1240 }}>
          <div
            style={{
              background: "var(--surface)",
              padding: m ? 10 : 18,
              borderRadius: radius + (m ? 10 : 18),
              boxShadow: "0 0 0 1px var(--line)",
            }}
          >
            <div
              className="relative overflow-hidden"
              style={{ height: H + (m ? 30 : 90), borderRadius: radius }}
            >
              {img}
              {decor}
            </div>
            <div
              className={cx(
                "flex",
                m
                  ? "flex-col gap-5 px-2 pb-3 pt-6"
                  : "items-end justify-between gap-10 px-4 pb-4 pt-9",
              )}
            >
    ...
    case "bleed": {
      ...
      return (
        <div
          {...data}
          className={cx("grid", m ? "grid-cols-1" : "grid-cols-2")}
          style={{ minHeight: m ? undefined : H + 280 }}
        >
          <div
    ...
    default:
      return (
        <div {...data} className="pb-2">
          ...
          >
            {avatar}
            <div className={cx("flex w-full flex-col items-center", avatar ? "mt-5" : "")}>
              {children({ align: "center", onMedia: false })}
            </div>
          </div>
        </div>
