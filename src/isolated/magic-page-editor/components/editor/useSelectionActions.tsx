        ...
        },
        {
          ...
          panel: (
            <Segmented
              ...
              value={
                props.shape ??
                (el?.querySelector("[data-hero]")?.getAttribute("data-shape") as string) ??
                "curve"
              }
              onChange={(v) => set("shape", v)}
            />
      ...
      return [
        ...
        },
        {
          ...
          panel: (
            <CtaStylePicker
              value={
                (props.variant as CtaVariant) ?? (el?.dataset.variant as CtaVariant) ?? "solid"
              }
              onChange={(v) => set("variant", v)}
            />
          ),
      ...
      return [
        {
          ...
          showLabel: true,
          panel: (
            <GalleryPhotosPicker value={current} onChange={(v) => set("items", v.join("|"))} />
          ),
        },
        {
          key: "layout",
