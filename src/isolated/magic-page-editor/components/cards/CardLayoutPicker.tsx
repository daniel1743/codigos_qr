  ...
  switch (layout) {
    ...
    case "bottom":
      return (
        <span
          className={cx(
            "flex h-full flex-col gap-1 p-1.5",
            layout === "bottom" && "flex-col-reverse",
          )}
        >
      ...
      {options.map((o) => {
        ...
        return (
          <button
            ...
            className={cx(
              "rounded-xl border p-1.5 text-left transition-colors duration-150",
          ...
          >
            ...
            <span className="mt-1.5 block px-0.5 text-[11.5px] font-medium leading-tight text-ink">
              {o.label}
            </span>
          </button>
        );
