  ...
  head: () => ({
    meta: [
      { title: "Plataforma de Conversión Completa | Cripqer" },
      {
        name: "description",
        content:
          "Más que un generador de QR. Construye el recorrido completo: Crear → Personalizar → Publicar → Atraer → Convertir → Gestionar → Medir → Mejorar.",
      },
      { property: "og:title", content: "Plataforma de Conversión Completa | Cripqer" },
      {
        property: "og:description",
        content:
          "De la atención al cliente recurrente. QR + Biolink + Analytics + Gestión integrada.",
      },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://www.cripqer.dev/plataforma" },
    ],
    links: [{ rel: "canonical", href: "https://www.cripqer.dev/plataforma" }],
  }),
    ...
    >
      ...
      >
        <div style={{ maxWidth: "1120px", margin: "0 auto", textAlign: "center" }}>
          ...
          >
            Cripqer no organiza enlaces. Construye y opera el recorrido completo de conversión de tu
      ...
      <section style={{ padding: "80px 20px", maxWidth: "1120px", margin: "0 auto" }}>
        ...
        >
          {[
            {
              titulo: "CREAR",
              desc: "Editor visual intuitivo para construir tu página en minutos",
            },
            {
              titulo: "PERSONALIZAR",
              desc: "Plantillas profesionales, colores, tipografía y tu identidad",
            },
        ...
        <div style={{ maxWidth: "1120px", margin: "0 auto" }}>
          ...
          >
            ...
            >
              ...
              >
                ❌ Sin página personalizada
                <br />
                ❌ Sin analytics
                <br />❌ Sin gestión de clientes
              </div>
            </div>
