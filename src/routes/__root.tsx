...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Generador de Código QR con Página Personalizada | Cripqer" },
      ...
      { property: "og:title", content: "Generador de Código QR con Página Personalizada | Cripqer" },
      ...
      { name: "twitter:title", content: "Generador de Código QR con Página Personalizada | Cripqer" },
