...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.criqper.dev/" },
      { property: "og:image", content: "https://www.criqper.dev/icon-512.png" },
      ...
      { name: "twitter:image", content: "https://www.criqper.dev/icon-512.png" },
    ],
    links: [
      { rel: "canonical", href: "https://www.criqper.dev/" },
      {
        rel: "stylesheet",
        href: appCss,
      },
