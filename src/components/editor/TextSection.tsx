...
// Modified by Claude Code — curated font list: removed near-duplicate
// generic sans (Roboto, Open Sans, Ubuntu, Fira Sans, Prompt, Barlow,
// Source Sans 3, Work Sans, Public Sans, Karla, Mulish, Lexend, Crimson
// Text, Sacramento, Great Vibes, Satisfy, Shadows Into Light) that were
// visually indistinguishable from fonts already kept. Categories are now
// grouped by visual personality instead of vague "Sans Modern/Clean"
// labels. All fonts used by templates (template-presets.ts) remain
// present so existing templates keep working.
...
const FONTS = [
  // Neutra: muy legible, sin personalidad marcada, ideal para textos largos
  { name: "Inter", category: "Neutra" },
  { name: "IBM Plex Sans", category: "Neutra" },
  { name: "Lato", category: "Neutra" },
  { name: "Nunito Sans", category: "Neutra" },
  // Geométrica: formas construidas, look de diseño/tech
  ...
  // Amigable: terminaciones suaves y redondeadas, tono cercano
  ...
  // Elegante: serifas clásicas y modernas, para marcas premium/editorial
  ...
  // Impacto: mayúsculas fuertes, para títulos y branding llamativo
  ...
  // Manuscrita: escritura a mano, tono personal/creativo
