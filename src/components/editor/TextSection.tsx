...
const FONTS = [
  ...
  { name: "Roboto", category: "Sans Modern" },
  { name: "Open Sans", category: "Sans Modern" },
  { name: "Lato", category: "Sans Modern" },
  ...
  { name: "Ubuntu", category: "Sans Modern" },
  { name: "Fira Sans", category: "Sans Modern" },
  { name: "IBM Plex Sans", category: "Sans Modern" },
  { name: "Space Grotesk", category: "Sans Modern" },
  { name: "Urbanist", category: "Sans Modern" },
  { name: "Prompt", category: "Sans Modern" },
  { name: "Josefin Sans", category: "Sans Modern" },
  { name: "Barlow", category: "Sans Modern" },
  ...
  { name: "Karla", category: "Clean" },
  { name: "Mulish", category: "Clean" },
  { name: "Cabin", category: "Clean" },
  { name: "Lexend", category: "Clean" },
  ...
  { name: "Comfortaa", category: "Rounded" },
  ...
  { name: "Sacramento", category: "Manuscrita" },
  { name: "Great Vibes", category: "Manuscrita" },
  { name: "Satisfy", category: "Manuscrita" },
  { name: "Permanent Marker", category: "Manuscrita" },
  { name: "Shadows Into Light", category: "Manuscrita" },
