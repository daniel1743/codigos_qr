...
const shapeOptions: DecorativeOption[] = [
  {
    id: "none",
    title: "Sin formas",
    description: "Limpio, sin figuras.",
    icon: RotateCcw,
  ...
  },
  {
    id: "circles",
    title: "Círculos",
    description: "Aros suaves de fondo.",
    icon: Circle,
  ...
  },
  {
    id: "squares",
    title: "Cuadrados",
    description: "Marcos editoriales.",
    icon: Square,
  ...
  },
  {
    id: "lines",
    title: "Líneas",
    description: "Trazos finos premium.",
    icon: Minus,
...
const effectOptions: DecorativeOption[] = [
  {
    id: "particles_none",
    title: "Sin partículas",
    description: "Fondo más sobrio.",
    icon: RotateCcw,
  ...
  },
  {
    id: "particles_dots",
    title: "Partículas",
    description: "Puntos finos dispersos.",
    icon: Sparkles,
  ...
  },
  {
    id: "smoke_soft",
    title: "Humo",
    description: "Velo suave y elegante.",
    icon: Cloud,
  ...
  },
  {
    id: "shadow_soft",
    title: "Sombra",
    description: "Profundidad inferior.",
    icon: Layers,
...
export function ElementsSection({ profile, onChange }: ElementsSectionProps) {
    ...
    <div className="space-y-7 pb-4">
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Decoraciones visuales para la página: formas, líneas, partículas, humo y sombras.
        </p>
      </div>
