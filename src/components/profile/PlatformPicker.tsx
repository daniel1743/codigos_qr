...
export function PlatformPicker({ value, onChange, className }: PlatformPickerProps) {
  ...
  const currentPlatform = PLATFORMS_CATALOG.find((p) => p.id === value) || PLATFORMS_CATALOG.find((p) => p.id === "other");
      ...
      <PopoverTrigger asChild>
        ...
        >
          <div className="flex items-center gap-2 truncate">
            ...
            <span className="truncate">{currentPlatform?.label || "Seleccionar plataforma..."}</span>
          </div>
