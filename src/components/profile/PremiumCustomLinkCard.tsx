...
export function PremiumCustomLinkCard({
  ...
  const radius =
    profile.button_radius === "full" ? "999px" : profile.button_radius === "none" ? "0px" : "24px";
  ...
  const premiumShadow =
    "inset 0 1px 1px rgba(255,255,255,0.4), inset 0 -1px 1px rgba(0,0,0,0.1), 0 8px 24px rgba(0,0,0,0.12)";
    ...
    return (
      ...
      >
        ...
        <div className="flex-1 p-6 text-left flex flex-col justify-center">
          ...
          {link.subtitle && (
            <p className="text-[13px] opacity-80 mb-5 leading-relaxed font-light">
              {link.subtitle}
            </p>
          )}
          <div>
  ...
  if (buttonStyle === "premium_image_right" || buttonStyle === "premium_image_left") {
    ...
    return (
      ...
      >
        <div
          className={"flex flex-col sm:flex-row h-full " + (!isRight ? "sm:flex-row-reverse" : "")}
        >
          <div className="flex-1 p-6 text-left flex flex-col justify-center">
            ...
            {link.subtitle && (
              <p className="text-[13px] opacity-90 mb-5 leading-relaxed font-light">
                {link.subtitle}
              </p>
            )}
            <div>
      ...
      >
        <div className="flex items-center gap-5 text-left">
          ...
          <div className="flex flex-col justify-center">
            ...
            {link.subtitle && (
              <p className="text-[12px] opacity-75 mt-0.5 max-w-[220px] leading-snug font-light">
                {link.subtitle}
              </p>
            )}
          </div>
