...
const Icon = {
  ...
  palette: (
    ...
    >
      ...
      <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.93 0 1.65-.75 1.65-1.69 0-.44-.18-.84-.44-1.13-.26-.29-.43-.69-.43-1.12 0-.94.75-1.69 1.68-1.69h2.03A5.54 5.54 0 0 0 22 10.8C22 5.9 17.5 2 12 2z" />
    </svg>
  ),
  type: (
    <svg
  ...
  menu: (
    ...
    >
      <path d="M4 2v20" />
      <path d="M8 2v7a2 2 0 0 1-4 0" />
      <path d="M15 2v20" />
      <path d="M15 9a3 3 0 0 0 3-3V2" />
    </svg>
  ),
  box: (
    <svg
    ...
    <div className="cq-phone cq-float">
      <div className="cq-phone-screen">
        ...
        <div className="cq-pf-body">
          <div className="cq-pf-avatar" style={{ background: avatarBg }}>
            {initials}
          </div>
          <h3 className="cq-pf-name">{name}</h3>
          <p className="cq-pf-role">{role}</p>
          {links.map((l) => (
            <span key={l} className="cq-pf-link" style={{ background: linkBg, color: linkColor }}>
              {l}
            </span>
          ))}
          <div className="cq-pf-socials">
            {["ig", "tt", "wa"].map((s) => (
              <i key={s} style={{ background: linkBg }} aria-hidden="true">
                {s === "ig" && (
                  <svg viewBox="0 0 24 24" fill="none" stroke={linkColor} strokeWidth="2">
                    <rect width="18" height="18" x="3" y="3" rx="5" />
                    <circle cx="12" cy="12" r="4" />
                    <circle cx="17.5" cy="6.5" r=".5" fill={linkColor} />
                  </svg>
                )}
                {s === "tt" && (
                  <svg
...
const TEMPLATES = [
  {
    label: "Profesional",
    bg: "linear-gradient(160deg,#f5f2ea,#e5ddcb)",
    av: "#111111",
    avc: "#F5F2EA",
    bar: "#ddd5c2",
    name: "#111111",
  ...
  {
    label: "Belleza",
    bg: "linear-gradient(160deg,#f7e8e4,#eccfc7)",
    av: "#8c4a3c",
    avc: "#fff",
    bar: "#e8c4ba",
    name: "#5e3228",
  ...
  {
    label: "Creador",
    bg: "linear-gradient(160deg,#262626,#0d0d0d)",
    av: "#B08D57",
    avc: "#111111",
    bar: "#3d3d3d",
    name: "#F5F2EA",
  ...
  {
    label: "Premium",
    bg: "linear-gradient(160deg,#111111,#2b2620)",
    av: "#F5F2EA",
    avc: "#111111",
    bar: "#4a4238",
    name: "#F5F2EA",
  ...
  {
    label: "Negocio",
    bg: "linear-gradient(160deg,#e4e9e4,#c9d4c9)",
    av: "#33463a",
    avc: "#fff",
    bar: "#c2cec2",
    name: "#22332a",
  ...
  {
    label: "Fotografía",
    bg: "linear-gradient(160deg,#1a1a1a,#000000)",
    av: "#d6d3cd",
    avc: "#111111",
    bar: "#3a3a3a",
    name: "#e8e5df",
  ...
  {
    label: "Lifestyle",
    bg: "linear-gradient(160deg,#efe6d4,#e0d0b2)",
    av: "#96784a",
    avc: "#fff",
    bar: "#e3d3b4",
    name: "#5c4a2c",
  ...
  {
    label: "Minimal",
    bg: "linear-gradient(160deg,#ffffff,#f2f2f0)",
    av: "#111111",
    avc: "#fff",
    bar: "#e4e4e0",
    name: "#111111",
    ...
    <div className="cq">
        ...
        mobileMenuContent={
          <div className="flex flex-col h-full pt-8 pb-4">
            <nav className="flex flex-col gap-2" aria-label="Navegación móvil principal">
              <a
                href="#producto"
                className="block rounded-xl px-4 py-3 text-lg font-medium text-white/80 hover:bg-white/10 hover:text-white transition-colors"
              >
                Producto
              </a>
              <a
            ...
            <div className="mt-auto flex flex-col gap-3 pt-6 border-t border-white/10">
              <Link
                to="/login"
                className="block rounded-xl px-4 py-3 text-center text-lg font-medium text-white bg-white/10 hover:bg-white/20 transition-colors"
              >
                Iniciar sesión
              </Link>
              <Link
                to="/login"
                search={{ mode: "register" }}
                className="block rounded-xl px-4 py-3 text-center text-lg font-medium text-black bg-[#D4AF37] hover:bg-[#e6c45b] transition-colors"
              >
                Crear mi QR
              </Link>
            </div>
      ...
      <section className="cq-hero" id="producto">
        <div className="cq-wrap cq-hero-grid">
          <div>
            <h1 className="cq-h1">
              La Plataforma de Conversión <em>Inteligente</em>
            </h1>
            <p className="cq-hero-sub">
              No solo enlaces. Construye el recorrido completo: De la atención al cliente
              recurrente. QR + Biolink + Analytics + Gestión en una sola plataforma.
            </p>
            <div className="cq-hero-actions">
              <Link
                to="/login"
                search={{ mode: "register" }}
                className="cq-btn cq-btn-accent"
                data-cta="crear-qr"
              >
                Crear mi QR {Icon.arrow}
              </Link>
              <a href="#disenos" className="cq-btn cq-btn-ghost" data-cta="ver-disenos">
                Ver diseños
              </a>
            </div>
      ...
      <section className="cq-section">
        <div className="cq-wrap cq-split">
          ...
          <div>
            ...
            <p className="cq-lead">
              Desde Instagram o TikTok, tu audiencia llega a una página que se ve y se siente como
              tú: tu foto, tu estilo, tus redes, tu contenido y tu contacto — todo en un solo lugar
              diseñado.
            </p>
            <div
              className="cq-mini-flow"
              aria-label="Flujo: perfil social, escaneo, página Cripqer"
            >
      ...
      <section className="cq-section cq-band">
        <div className="cq-wrap cq-split cq-rev">
          ...
          <div>
            ...
            <p className="cq-lead">
              Un QR en la mesa, el mostrador o la carta abre tu presencia en Cripqer: tu menú, tus
              servicios, tu WhatsApp, tu ubicación y lo que quieras que tus clientes encuentren.
            </p>
      ...
      <section className="cq-section">
        <div className="cq-wrap cq-split">
          ...
          <div>
            ...
            <h2 className="cq-h2">
              Una tarjeta de presentación que vive después del apretón de manos.
            </h2>
            <p className="cq-lead">
      ...
      <section className="cq-section" style={{ paddingTop: 24 }}>
        <div className="cq-wrap">
          <div className="cq-dark-section">
            <span className="cq-eyebrow" style={{ color: "var(--cq-accent)" }}>
              La diferencia
            </span>
            <h2 className="cq-h2">Linktree organiza enlaces. Cripqer construye conversión.</h2>
            <p className="cq-lead">
              No se trata solo de reunir enlaces. Se trata de crear el recorrido completo: desde que
              alguien te descubre hasta que se convierte en cliente recurrente.
            </p>
            <div className="cq-compare">
              ...
              <div className="cq-compare-card cq-compare-new">
                <h3>Cripqer</h3>
                <p>
                  Construye el recorrido completo: atrae, convierte, gestiona, mide y optimiza tu
                  negocio.
                </p>
      ...
      <section className="cq-section cq-center">
        <div className="cq-wrap">
          ...
          <p className="cq-lead" style={{ margin: "0 auto" }}>
            No solo generas un QR. Construyes el sistema completo que lleva a tu audiencia desde el
            primer contacto hasta la conversión, gestión y crecimiento continuo.
          </p>
      ...
      <section className="cq-section cq-band" id="disenos">
        <div className="cq-wrap cq-center">
          ...
          <p className="cq-lead" style={{ margin: "0 auto" }}>
            Empieza desde una base visual profesional — no desde una página en blanco. Cada familia
            de diseño tiene su propia personalidad.
          </p>
            ...
            {TEMPLATES.map((t) => {
              ...
              return (
                <div
                  key={t.label}
                  className="cq-tpl"
                  style={shot ? undefined : { background: t.bg }}
                  data-template={t.label}
                >
                  {shot ? (
                    <img
                      className="cq-tpl-shot"
                      src={shot}
                    ...
                    <div className="cq-tpl-inner">
                      <div className="cq-tpl-av" style={{ background: t.av, color: t.avc }}>
                        {t.label[0]}
                      </div>
                      <span className="cq-tpl-name" style={{ color: t.name }}>
                        Nombre Apellido
                      </span>
                      <div className="cq-tpl-bars">
                        <i style={{ background: t.bar }} />
                        <i style={{ background: t.bar }} />
                        <i style={{ background: t.bar }} />
                      </div>
                    </div>
      ...
      <section className="cq-section">
        <div className="cq-wrap cq-split">
          <div>
            ...
            <p className="cq-lead">
              Elige una plantilla, cambia la foto, mueve los colores, edita el texto y mira el
              resultado al instante. Sin código, sin hosting, sin diseño web.
            </p>
            <div
              className="cq-swatches"
              role="group"
              aria-label="Cambiar color de la plantilla de ejemplo"
            >
              {SWATCHES.map((c, i) => (
                <button
                  key={c}
          ...
          <div className="cq-split-media" style={{ maxWidth: "none" }}>
            ...
            <div className="cq-editor" style={{ width: "100%" }}>
              <div className="cq-editor-bar" aria-hidden="true">
                <i />
                <i />
                <i />
              </div>
              {MEDIA.editorVisualUrl ? (
                <img
                  className="cq-editor-shot"
                  src={MEDIA.editorVisualUrl}
                  alt="Editor visual de Cripqer"
                  loading="lazy"
                />
              ) : (
                <div className="cq-editor-body">
                  ...
                  <div className="cq-editor-stage">
                    ...
                    >
                      <div
                        className="cq-tpl-av"
                        style={{ background: active.av, color: active.avc, margin: "0 auto 8px" }}
                      >
                        Tú
                      </div>
                      <div className="cq-tpl-name" style={{ color: active.name }}>
                        Tu nombre
                      </div>
                      <div className="cq-tpl-bars" style={{ margin: "12px auto 0" }}>
                        <i style={{ background: active.bar }} />
                        <i style={{ background: active.bar }} />
                      </div>
                    </div>
                  </div>
        ...
        <div className="cq-wrap cq-split cq-rev">
          <div className="cq-split-media">
            <div className="cq-protect-card">
              ...
              <div className="cq-protect-row">
                {Icon.file}
                <div>
                  Propuesta comercial.pdf<small>Contenido protegido</small>
                </div>
              </div>
              <div className="cq-protect-row">
                {Icon.scan}
                <div>
                  QR dedicado<small>Acceso controlado</small>
                </div>
              </div>
              <div className="cq-protect-row">
                {Icon.lock}
                <div>
                  Contraseña requerida<small>Acceso mediante contraseña</small>
                </div>
              </div>
            </div>
          </div>
          <div>
            ...
            <p className="cq-lead">
              Cripqer también incluye un flujo para documentos y contenido protegido: genera un QR
              con acceso controlado por contraseña y compártelo solo con quien corresponda.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="cq-section cq-center">
        <div className="cq-wrap">
          ...
          <p className="cq-lead" style={{ margin: "0 auto" }}>
            Personas distintas, contextos distintos, la misma necesidad: que lo que la gente vea
            después de escanear represente quién eres y lo que ofreces.
          </p>
      ...
      <section>
        <div className="cq-wrap">
          <div className="cq-final">
            ...
            <p>
              Construye la experiencia que quieres que las personas descubran cuando escanean tu QR.
            </p>
      ...
      <PlatformFooter
        className="cq-footer"
        innerClassName="cq-wrap cq-footer-in"
        logoClassName="cq-logo"
      >
