...
export const INITIAL_CATEGORIES: Category[] = [
  { id: 'c-nuevo', label: 'Nuevo', style: { backgroundColor: '#F5F2ED', textColor: '#17140F', font: 'Inter, system-ui, sans-serif', size: 11.5, radius: 999 } },
  { id: 'c-edicion-limitada', label: 'Edición limitada', style: { backgroundColor: '#F5F2ED', textColor: '#17140F', font: 'Inter, system-ui, sans-serif', size: 11.5, radius: 999 } },
  { id: 'c-hecho-a-medida', label: 'Hecho a medida', style: { backgroundColor: '#F5F2ED', textColor: '#17140F', font: 'Inter, system-ui, sans-serif', size: 11.5, radius: 999 } },
  { id: 'c-bienestar', label: 'Bienestar', style: { backgroundColor: '#F5F2ED', textColor: '#17140F', font: 'Inter, system-ui, sans-serif', size: 11.5, radius: 999 } }
];
