  ...
  return (
    ...
    >
      <div className="flex min-w-0 flex-1 items-center gap-3">
        <span className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-black text-[13px] font-semibold text-white">
          C
        </span>
        <div className="min-w-0">
          <p className="truncate font-display text-[15.5px] leading-tight text-ink">Cripqer</p>
          <p className="truncate text-[12px] text-muted">Catálogo · {products.length} productos</p>
        </div>
      </div>
      ...
      <div className="flex flex-1 shrink-0 items-center justify-end gap-2">
        ...
        <button
          ...
          className="h-11 rounded-xl bg-black px-4 text-[13.5px] font-medium text-white transition-colors duration-150 ease-premium hover:bg-neutral-800 lg:h-10"
        >
          Publicar
        </button>
      </div>
