  ...
  return (
    <Modal
      ...
      <div>
          ...
          ['upload', 'Subir foto', UploadCloudIcon]] as
          const).
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  active ? 'border-sel shadow-[0_0_0_2px_rgba(47,111,237,0.35)]' : 'border-hairline hover:shadow-card'
                )}>
        ...
        <div className="mt-5">
              <label className="flex w-full cursor-pointer flex-col items-center justify-center gap-2 rounded-2xl border border-dashed border-[#D6CFC5] bg-[#FBF9F6] px-6 py-12 transition-colors duration-150 ease-premium hover:border-brand hover:bg-brandSoft/40">
                <input 
                  type="file" 
                  ...
                  onChange={(e) => {
                    ...
                    if (file) startUpload(product.id, file);
                  }}
                />
