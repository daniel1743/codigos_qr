...
| **3. Diseño**           | ➔ **Apariencia** -> _Personalizar_ | Elección de plantillas, color/tipo de Fondo, colores de Botones y forma de Avatar.          |
| **4. Texto**            | ➔ **Apariencia** -> _Tipografía_   | Familia de fuentes, tamaños, peso y alineación de textos de la página.                      |
| **5. Elementos**        | ➔ **Apariencia** -> _Decoración_   | Formas de fondo flotantes (círculos, líneas, cuadrados) y partículas en movimiento.         |
...
_Documento creado el 21 de agosto de 2026 para el control de versiones de QR-UI._
