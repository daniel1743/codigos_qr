...
- En la función de contraste (checkContrast), el texto de la alerta ha sido redactado de forma más descriptiva: _"Contraste bajo. Este texto puede ser difícil de leer. Usar color recomendado"_.
