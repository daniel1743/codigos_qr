...
2. **Forma/efecto hover visible en reposo:** Los botones con estilos "solid" y "pill" presentaban un resplandor inclinado decorativo (shine) que, por falta de propiedades de _overflow_, sobresalía estáticamente a la izquierda del botón antes de que el usuario interactuara con él.
...
Se sustituyó por un grupo de representaciones abstractas (esqueletos o _skeletons_):
