...
El concepto "Define tu paleta" (Background, Surface, Accent, Text) queda formalmente documentado para el futuro como _DEFERRED_. Actualmente el sistema UI-07 + UI-07A cubre eficientemente las necesidades MVP mediante legibilidad automática (YIQ) y presets pulidos.
