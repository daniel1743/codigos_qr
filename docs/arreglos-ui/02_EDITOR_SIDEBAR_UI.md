...
En resoluciones móviles (`< 768px`), el Sidebar lateral desaparece y se convierte en un **Bottom Navigation Bar**. Al seleccionar una opción, el panel contextual emerge desde abajo como un _Bottom Sheet_ con sombra superior y manejador de arrastre simulado, dejando la previsualización siempre a mano al fondo.
