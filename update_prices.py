...
if not has_gano:
    products.append({
        ...
        "category": "Inmunológica y Nutrición",
        "short_description": "Café cappuccino con Ganoderma lucidum.",
...
cat_map = {
    ...
    "Inmunológica y Nutrición": "Inmunológica y Nutrición"
}
...
print("products-fuxion.ts updated successfully with new prices!")
